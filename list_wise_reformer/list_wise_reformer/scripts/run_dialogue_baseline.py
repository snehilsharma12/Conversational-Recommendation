...
from list_wise_reformer.models.DialoRanker import DialoRanker
...
def run_experiment(args):
    ...
    if args.ranker == 'bert' or args.ranker == 'dialo':
...
def main():
    ...
    if "pre_trained_on" in args.model:
        print(args.model)
        args.ranker = 'pre_trained_on' + args.model.split("pre_trained_on")[-1]
